...
example : <h1> - <h6>, <li>, <div>, etc [read more](https://www.w3schools.com/html/html_blocks.asp)

## Inline statements
An inline element does not start on a new line and only takes up as much width as necessary.

example : <a>, <button>, <input> [read more](https://www.w3schools.com/html/html_blocks.asp)
